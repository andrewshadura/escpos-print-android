 ...
 * Misc util methods
 */
class EscPosPrinterDiscoveryUtils {
    /**
     ...
     */
    static PrintAttributes.Resolution getResolutionFromAttributeValue(@NonNull String id, AttributeValue attributeValue) {
     ...
     */
    static PrintAttributes.MediaSize getMediaSizeFromAttributeValue(AttributeValue attributeValue) {
